...
A direção terá a reponsabilidade de controlar a direção. Ela oferece os sequintes
atributos:
...
class Motor:
    ...
    def frear(self):
        self.velocidade -= 2
        self.velocidade = max(0, self.velocidade)  # Funcao que faz com que o maior seja retornado evitando negativos.


NORTE = 'Norte'  # ATRIBUTO DE CLASSE
SUL = 'Sul'
LESTE = 'Leste'
OESTE = 'Oeste'
...
class Direcao:
    """Quando se tem muitos if/elif algumas vezes dict podem substituir essa estrutura
    lembra a estrutura dado:chave:valor. ATRIBUTO DE CLASSE A SEGUIR. """
